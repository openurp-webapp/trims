...
<table class="TableNormal" align="center" border="1" bordercolor="#666666" cellpadding="1" cellspacing="0" width="95%">
  ...
  <tr class="TrNormal">
	<td class="TdLabel" align="center" nowrap="nowrap" width="90">课程教材</td>
	<td colspan="3" class="TdContent" width="100%">
		<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr class="TrNormal">
				<td class="TdContent" width="50%">
					&nbsp;<a href="TuShuXiangXi.asp?Id=4" title="查看详细信息">XXXXX</a>
				</td>
			</tr>
		</tbody>
		</table>
  ...
  <tr class="TrNormal">
	<td class="TdLabel" align="center" nowrap="nowrap" width="90">课程参考书</td>
	<td colspan="3" class="TdContent" width="100%">
		<table class="TableNormal" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
		<tbody>
			<tr class="TrNormal">
				<td class="TdContent" width="50%">
					&nbsp;<a href="TuShuXiangXi.asp?Id=5" title="查看详细信息">XXXX</a>
				</td>
			</tr>
		</tbody>
		</table>
  ...
  <tr class="TrNormal">
	...
	<td colspan="3" class="TdContent" width="100%"></td>
  </tr>
</table>
<br>
<div align="center">
