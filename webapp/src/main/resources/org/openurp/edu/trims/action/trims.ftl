[#ftl]
[#macro yearAndDepartCondition years=[] term=false teaching="" depart=true]
  [#if years?size gt 0]
...
[#macro termAndDepartCondition years=[] teaching="" depart=true]
  [@yearAndDepartCondition years=years term=true teaching=teaching depart=depart/]
[/#macro]
