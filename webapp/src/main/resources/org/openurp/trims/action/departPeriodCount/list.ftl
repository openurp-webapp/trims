...
[#if year??]学年：${year}[/#if][#if term??]&nbsp;&nbsp;&nbsp;&nbsp;学1期：${term}[/#if]
</div>
<script src="${base}/static/js/echarts/echarts.js"></script>
<script src="${base}/static/js/echarts/theme/macarons.js"></script>
<script type="text/javascript">
    ...
    require(
        ...
        function (ec) {
            ...
            var myChart = ec.init(document.getElementById('lessonTrimsChart'), 'macarons'); 
